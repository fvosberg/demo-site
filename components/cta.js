const CTA = () => (
  <section className="pt-20 pb-24 bg-blue-600">
    <div className="max-w-xl mx-auto text-center">
      ...
      <div className="mt-6"><a className="inline-block text-xs py-4 px-8 bg-white hover:bg-blue-600 text-blue-600 hover:text-white font-semibold leading-none border hover:border-white rounded transition duration-300" href="#">Check Now</a></div>
    </div>
  </section>
);
