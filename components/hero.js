    ...
    <div className="container px-4 mx-auto">
      ...
      <div className="relative max-w-3xl mt-6 mb-8 mx-auto">
        ...
        <div className="absolute" style={{top: '3%', left: '9%', width: '82%', height: '90%'}}>
          <img className="object-contain w-full h-full" src="metis-assets/elements/app-mockup.png" alt />
        </div>
      </div>
      <div className="flex flex-wrap justify-between pt-8 pb-16">
        <div className="flex w-1/2 lg:w-auto py-4">
          <div className="flex justify-center items-center bg-blueGray-50 rounded-xl h-12 w-12 sm:h-20 sm:w-20">
            <img className="h-6 sm:h-8" src="metis-assets/icons/user-circle.svg" alt />
          </div>
          <div className="sm:py-2 ml-2 sm:ml-6">
            <span className="sm:text-2xl font-bold font-heading">250 324</span>
            <p className="text-xs sm:text-base text-blueGray-400">Followers</p>
          </div>
        </div>
        <div className="flex w-1/2 lg:w-auto py-4">
          <div className="flex justify-center items-center bg-blueGray-50 rounded-xl h-12 w-12 sm:h-20 sm:w-20">
            <img className="h-6 sm:h-8" src="metis-assets/icons/puzzle.svg" alt />
          </div>
          <div className="sm:py-2 ml-2 sm:ml-6">
            <span className="sm:text-2xl font-bold font-heading">6 510</span>
            <p className="text-xs sm:text-base text-blueGray-400">Solved Problems</p>
          </div>
        </div>
        <div className="flex w-1/2 lg:w-auto py-4">
          <div className="flex justify-center items-center bg-blueGray-50 rounded-xl h-12 w-12 sm:h-20 sm:w-20">
            <img className="h-6 sm:h-8" src="metis-assets/icons/thumb-up.svg" alt />
          </div>
          <div className="sm:py-2 ml-2 sm:ml-6">
            <span className="sm:text-2xl font-bold font-heading">14 350</span>
            <p className="text-xs sm:text-base text-blueGray-400">Happy Customers</p>
          </div>
        </div>
        <div className="flex w-1/2 lg:w-auto py-4">
          <div className="flex justify-center items-center bg-blueGray-50 rounded-xl h-12 w-12 sm:h-20 sm:w-20">
            <img className="h-6 sm:h-8" src="metis-assets/icons/terminal.svg" alt />
          </div>
          <div className="sm:py-2 ml-2 sm:ml-6">
            <span className="sm:text-2xl font-bold font-heading">149 324</span>
